...
Threat.Sleep(n) bedeuted, dass der aktuelle Threat für n Zeiteinheiten geblockt wird. Die Länge einer Zeiteinheit ist verschieden, je nach OS Versionen, Prozessor und generellen Schwankungen von mehreren Millisekunden. Dies bedeutet, dass der Threat sehr wahrscheinlich für mehr als n Millisekunden blockiert wird. Die Threats werden nicht innerhalb der 5ms Tacktung fertig und es kommt zum Fehlverhalten.
